# Il paradosso generativo: la kenosi come forma trascendentale del dire l'indicibile

**The Generative Paradox: Kenosis as the Transcendental Form of Saying the Unsayable**
...
La presente ricerca affronta una questione fondamentale della teologia medievale e della filosofia del linguaggio religioso: come è possibile che l'impossibilità di una predicazione adeguata su Dio generi, anziché condannare al silenzio, forme sempre nuove di discorso teologico? L'articolo propone il concetto di *paradosso generativo* come principio strutturale unificante dell'intera apparatus apofatica medievale. Questo paradosso opera attraverso una triplice kenosi: ontologica (l'Incarnazione come ingresso del Logos nella carne), semantica (lo svuotamento dei predicati dal loro contenuto creaturale nel passaggio al divino), e pragmatica (la trasformazione dell'atto predicativo da asserzione descrittiva a gesto indicativo). Queste tre kenosi non sono meramente parallele, ma strutturalmente omologhe, fondate dalla kenosi cristologica e governate dalla grammatica calcedonese. La ricerca dimostra che i quattro avverbi della formula di Calcedonia (ἀσυγχύτως, ἀτρέπτως, ἀδιαιρέτως, ἀχωρίστως) funzionano come regole di trasformazione profonde per *tutta* la predicazione teologica medievale. Il paradosso è generativo non perché contraddittorio, ma perché il limite linguistico, fondato nell'evento kenotico, diviene risorsa produttiva: le negazioni elevate, i paradossi indicativi, le metafore autodesostentative costituiscono una modalità discorsiva inedita, né puramente apofatica né catafatica. Infine, l'analisi del "quarto momento" rivela come il discorso apofatico converga sempre verso una destinazione pragmatica determinata dalla fondazione metafisica: dossologica nel corpus dionisiano, scientifico-istituzionale nella tradizione medievale latina, ricognitiva nell'Advaita, terapeutica nel buddhismo Mādhyamika, pratico-spontanea nel Daoismo. Questo studio costituisce un contributo originale alla filosofia della linguaggio religioso, alla teologia medievale, e alla filosofia comparata della religione.
...
This research addresses a fundamental question of medieval theology and the philosophy of religious language: how is it possible that the impossibility of adequate predication about God generates, rather than condemning to silence, ever-new forms of theological discourse? The article proposes the concept of *generative paradox* as the unifying structural principle of the entire medieval apophatic apparatus. This paradox operates through a triple kenosis: ontological (the Incarnation as the entry of the Logos into flesh), semantic (the emptying of predicates of their creaturely content when applied to the divine), and pragmatic (the transformation of the predicative act from descriptive assertion to indicative gesture). These three kenoses are not merely parallel but structurally homologous, founded by christological kenosis and governed by the Chalcedonian grammar. The research demonstrates that the four adverbs of the Chalcedonian formula (ἀσυγχύτως, ἀτρέπτως, ἀδιαιρέτως, ἀχωρίστως) function as deep transformation rules for *all* medieval theological predication. The paradox is generative not because contradictory, but because the linguistic limit, founded in the kenotic event, becomes a productive resource: elevated negations, indicative paradoxes, self-deconstructive metaphors constitute an unprecedented discursive modality, neither purely apophatic nor cataphatic. Finally, analysis of the "fourth moment" reveals how apophatic discourse always converges toward a pragmatic destination determined by metaphysical foundation: doxological in the Dionysian corpus, scientific-institutional in the Latin medieval tradition, recognitive in Advaita, therapeutic in Mādhyamika Buddhism, practical-spontaneous in Daoism. This study constitutes an original contribution to the philosophy of religious language, medieval theology, and comparative philosophy of religion.
...
## 1. INTRODUZIONE: OLTRE LA DOPPIA KENOSI

### 1.1 La traiettoria della ricerca

L'intera ricerca che ora culmina in questo articolo ha seguito una progressione sistematica. Gli articoli precedenti (File 1-3) hanno stabilito le fondamenta su cui il presente contributo si costruisce. Il File 1 ha sviluppato l'analisi della *grammatica dell'ineffabilità*: mostrato come il discorso apofatico medievale non sia un semplice rifiuto della predicazione, bensì un'elaborazione sofisticata di come il linguaggio ordinario si trasforma quando interseca il sacro. Il File 2 ha approfondito il fondamento cristologico di questa trasformazione, tracciando la linea che conduce da Filone attraverso Massimo il Confessore fino ai teologi medievali, dimostrando come l'evento dell'Incarnazione fondi la possibilità stessa della doppia kenosi semantica e pragmatica. Il File 3, infine, ha collocato questo dispositivo medievale cristiano all'interno di un orizzonte comparativo globale, mostrando come strategie formalmente simili di apofatismo compaiano nell'Advaita Vedānta, nel buddhismo Mādhyamika, e nelle tradizioni daoiste, pur servendo scopi pragmatici radicalmente diversi.

Tuttavia, rimane una questione decisiva che nessuno dei tre articoli precedenti ha affrontato completamente: *qual è il principio strutturale unitario che sottende a questo intero apparato?* Come si collegano organicamente la fondazione cristologica, la doppia kenosi, e la diversità delle destinazioni pragmatiche? C'è un unico principio che unifica tutte queste dimensioni in un sistema coerente? E, se esiste, quale contributo originale alla teoria della linguaggio religioso esso rappresenta?

La presente ricerca affronta precisamente queste questioni attraverso l'introduzione di un nuovo concetto: il *paradosso generativo*. Questo paradosso non è una semplice contraddizione logica, né una paralizzante aporia. Piuttosto, è un principio strutturale per il quale il limite stesso della predicazione su Dio — il fatto che ogni nostra parola rimane incommensurabilmente distante dal divino — genera forme sempre nuove di discorso teologico. Non è la negazione che produce il silenzio, ma la negazione che produce l'elevazione; non è l'impossibilità che arresta il linguaggio, ma l'impossibilità che lo reindirizza verso modalità discorsive inedite.

### 1.2 La tesi principale: il paradosso generativo

Il cuore della presente proposta è l'affermazione seguente: *l'intero apparato medievale della predicazione teologica può essere compreso come l'elaborazione progressiva di un singolo principio strutturale, il paradosso generativo, che consiste nel fatto che l'impossibilità stessa di una predicazione adeguata su Dio GENERA forme nuove di discorso anziché condannare al silenzio*. Questo paradosso non opera casualmente, bensì secondo una logica interna rigorosa, fondata nella struttura ontologica dell'Incarnazione e governata dalla grammatica profonda della formula calcedonese.

Per intendere pienamente la natura di questo paradosso, è necessario distinguerlo da altre forme di paradosso o aporia che compaiono in altre tradizioni religiose e filosofiche. Il paradosso del mentitore ("questa affermazione è falsa") è meramente contraddittorio, e non genera nulla se non confusione logica. I paradossi di Zenone, sebbene filosoficamente fecondi, generano analisi ma non nuove modalità discorsive. Il paradosso dello śūnyatā nel buddhismo Mādhyamika — l'affermazione che anche il vuoto è vuoto — genera un effetto terapeutico, dissolvendo l'attaccamento alle visioni concettuali, ma non produce nuove forme affermative di discorso. Il *paradosso generativo* cristiano medievale, al contrario, genera continuamente nuovi modi di predicare: le negazioni elevate (il "nulla" di Dionigi che è più pienezza che vuoto), i paradossi indicativi (le definizioni auto-destabilizzanti del Liber XXIV philosophorum), le metafore che si costruiscono per dissolversi (la "sfera il cui centro è ovunque e la circonferenza in nessun luogo").

### 1.3 La struttura della kenosi tripla

Il paradosso generativo opera attraverso una struttura articolata su tre livelli, che insieme costituiscono una *kenosi tripla*:

**Primo livello: Kenosi Ontologica.** È il fondamento strutturale nell'evento dell'Incarnazione. Nel celebre inno cristologico di Filippesi 2:6-11, il Logos, pur possedendo la forma di Dio (μορφὴ θεοῦ), non considera questa uguaglianza con Dio come qualcosa da afferrare gelosamente (ἁρπαγμὸν), ma la rinuncia volontariamente, assume la forma di schiavo (μορφὴν δούλου λαβών), e discende fino alla morte di croce. Questa è la kenosi nel senso radicale: lo svuotamento del Logos della sua gloria celeste, la sua discesa nell'ordine creaturale. Ma è cruciale notare che questa discesa non è un'annichilimento: il Logos rimane pienamente divino pur essendo pienamente umano. La struttura di questa simultaneità — infinito nel finito, eternità nel tempo, trascendenza nell'immanenza — senza confusione e senza divisione, è il modello strutturale che governa tutti gli altri livelli di kenosi.

**Secondo livello: Kenosi Semantica.** È l'operazione che avviene a livello del significato predicativo. Quando un predicato creaturale — ad esempio, la bontà (ἀγαθότης) — viene applicato a Dio, non può conservare il medesimo contenuto semantico che possiede quando riferito alle creature. Una creatura è buona in modo parziale, temporale, limitato: la sua bontà è una qualità che possiede tra altre qualità. Ma Dio non è buono *tra* altre cose, non è buono *temporalmente* o *parzialmente*. La sua bontà è la sua essenza stessa. Pertanto, il predicato "buono" subisce un'operazione di svuotamento: il suo modus significandi (il modo finito in cui ordinariamente significa) viene sottratto, mentre la sua res significata (la perfezione in sé) viene preservata ed elevata. È una kenosi semantica: il predicato entra nel dominio divino per essere trasformato.
...
La kenosi semantica è possibile perché la kenosi ontologica ha già avuto luogo. I predicati non vengono svuotati arbitrariamente; vengono svuotati secondo una logica interna, quella dell'analogia, che è essa stessa fondata nella struttura cristologica: come il Logos rimane pienamente Logos pur essendo pienamente umano, così il significato creaturale rimane veramente significato — non è semplicemente cancellato — pur essendo trasformato nella sua applicazione al divino.

La kenosi pragmatica, a sua volta, è resa possibile dalla kenosi semantica. Perché l'atto di predicazione possa trasformarsi da descrizione a indicazione, è necessario che il predicato sia stato già semanticamente processato, svuotato e elevato. Solo un discorso che ha subito la kenosi semantica può compiere l'atto della kenosi pragmatica — può cioè orientare il parlante/ascoltatore verso il divino senza pretendere di descriverlo.

### 1.5 La grammatica calcedonese come struttura profonda

Questa omologia strutturale è governata da una grammatica profonda: quella della formula di Calcedonia. Quando il concilio ecumenico di Calcedonia (451) formulò la definizione cristologica, produsse una dichiarazione che, a prima vista, appare puramente cristologica:

> "Uno e il medesimo Cristo, Figlio, Signore, unigenito, da riconoscersi in due nature, senza confusione, senza mutamento, senza divisione, senza separazione; la differenza delle nature non è affatto tolta dall'unione, ma piuttosto le proprietà di ciascuna natura sono conservate e concorrono in una sola persona e una sola ipostasi."

Ma questi quattro avverbi — ἀσυγχύτως (senza confusione), ἀτρέπτως (senza mutamento), ἀδιαιρέτως (senza divisione), ἀχωρίστως (senza separazione) — funzionano come *regole di trasformazione* non soltanto per la cristologia, ma per *tutta* la predicazione teologica medievale. Essi forniscono la struttura logica secondo la quale un predicato ordinario viene convertito in predicato teologico.

ἀσυγχύτως (senza confusione): il predicato creaturale non è fuso, non è confuso con il divino; rimane intelligibile come predicato creaturale. Quando diciamo "Dio è buono," la bontà creaturale non scompare nel nostro dire; conserva una certa autonomia semantica.

ἀχωρίστως (senza separazione): nonostante questa distinzione, il predicato nondimeno raggiunge veramente il divino, non è separato da esso. Non si tratta di un'omonimia equivoca, dove la parola "buono" avrebbe completamente due significati sconnessi. La "bontà" in Dio e la "bontà" in creatura rimangono intrinsecamente collegate.

ἀτρέπτως (senza mutamento): l'applicazione del predicato non trasforma Dio, non lo riduce o lo altera. Dio rimane assolutamente trascendente, immutabile, in sé. L'atto di predicazione non produce alcun mutamento nella realtà divina.

ἀδιαιρέτως (senza divisione): il significato del predicato non viene scisso in due parti separate, una per la creatura e una per Dio. Esiste un'unità di significato che attraversa la differenza ontologica, pur mantenendo la differenza.

Questa grammatica calcedonese è, sostengo, la *struttura profonda* (in senso quasi chomskiano) di tutta la predicazione teologica medievale. Gli autori medievali non la citano sempre esplicitamente — sebbene spesso lo facciano — ma vi conformano il loro discorso. Essa governa come un sistema di vincoli il modo in cui il linguaggio ordinario si trasforma nel linguaggio teologico.

### 1.6 Novità della presente ricerca

Perché questa ricerca rappresenta un contributo genuinamente originale? La letteratura medievale ha riconosciuto la doppia kenosi semantica e pragmatica. È stata studiata la fondazione cristologica della predicazione teologica. È stata esplorata la dimensione comparativa dell'apofatismo. Ma nessuno ha:

**(1)** Fondato esplicitamente e sistematicamente la doppia kenosi (semantica e pragmatica) nella kenosi ontologica cristologica, mostrando come la struttura dell'Incarnazione generi le strutture della predicazione;

**(2)** Formalizzato la grammatica calcedonese come il sistema profondo di regole di trasformazione che governa *tutta* la predicazione teologica medievale, non soltanto la cristologia;

**(3)** Introdotto il concetto di *paradosso generativo* per caratterizzare il modo specificamente cristiano di intendere il limite linguistico non come fallimento, bensì come risorsa produttiva;

**(4)** Dimostrato che questa generatività è inesplicabile senza il fondamento kenotico-cristologico, e che essa non è presente (nello stesso modo) in altre tradizioni apofatiche come il buddhismo Mādhyamika, l'Advaita Vedānta, o il Daoismo;

**(5)** Sviluppato la nozione del "quarto momento" come il punto di convergenza pragmatica nel quale il discorso apofatico raggiunge la sua destinazione finale, destinazione che è radicalmente determinata dalla fondazione metafisica sottostante.

Questi cinque elementi insieme costituiscono il contributo originale della presente ricerca. Essi trasformano ciò che è stato trattato come una raccolta di strategie disparate (la negazione in Dionigi, la translatio in Alano, la res significata / modus significandi in Tommaso, la negatio negationis in Eckhart) in un *sistema strutturale unificato*, governato da una grammatica profonda e fondato in una ontologia coerente.

---

## 2. LA STRUTTURA TRIPLICE DELLA KENOSI LINGUISTICA

### 2.1 Kenosi Ontologica: il fondamento nell'Incarnazione

La ricerca della struttura più profonda della predicazione teologica medievale conduce, inevitabilmente, all'evento dell'Incarnazione. Non è possibile comprendere come la predicazione teologica funzioni senza affrontare la questione: *perché il linguaggio umano può predicare del divino?* La risposta che la tradizione medievale cristiana offre è radicale: perché il Logos stesso è entrato nel linguaggio, si è fatto carne, si è reso comunicabile in termini umani. L'Incarnazione non è dunque un dato puramente teologico; è la condizione di possibilità della predicazione teologica stessa.

L'inno cristologico di Filippesi 2:6-11 fornisce la narrazione strutturale di questa kenosi ontologica:

> Egli, pur essendo nella forma di Dio, non considerò l'uguaglianza con Dio una preda da afferrare, ma svuotò sé stesso, prendendo la forma di schiavo, divenendo simile agli uomini; e trovato nell'aspetto come un uomo, umiliò sé stesso, divenendo obbediente fino alla morte, e morte di croce. Per questo Dio lo esaltò e gli diede il nome che è al di sopra di ogni nome.¹

Il verbo cruciale è ἐκένωσεν (ekenōsen) — si svuotò. Questa non è una divinizzazione dell'umano (come nel mitho greco), ma uno svuotamento del divino nel finito. Il Logos abbandona la μορφὴ θεοῦ (forma di Dio), l'ἰσότης θεῷ (uguaglianza con Dio), e assume la μορφὴν δούλου (forma di schiavo). È una discesa radicale, una penetrazione del divino nell'ordine creaturale.

Tuttavia — e questo è il punto che Calcedonia porterà a completa chiarezza — questa discesa non è un'annichilimento. Il Logos rimane il Logos. Non diviene un'entità ibrida tra divino e umano; rimane pienamente divino mentre diviene pienamente umano. La simultaneità di questi due ordini — infinito e finito, eternità e tempo, trascendenza e immanenza — senza che l'uno si confonda con l'altro, né l'uno si separi dall'altro, è la struttura ontologica della Incarnazione.

Massimo il Confessore sviluppa questa struttura attraverso il concetto del Logos e dei logoi. Il Logos divino contiene tutti i logoi — i principi intelligibili, i significati — di tutte le cose create.² Gli esseri umani sono κατ᾿ ἰδίαν λογικοί, cioè razionali secondo il lógo loro proprio, perché formati all'immagine del Logos. Ma questo significa che gli esseri umani, come creature linguistiche (logikoi), sono strutturati secondo la stessa logica con cui il Logos contiene i logoi. In altri termini, il linguaggio umano non è un'invenzione posteriore; è la struttura stessa della creazione, una struttura che riproduce il modo in cui il Logos eterno contiene i significati.

Quando il Logos si incarna, dunque, non irrompe semplicemente nella storia come un corpo esterno al linguaggio. Piuttosto, l'Incarnazione è *l'ingresso del Logos nei logoi*, l'ingresso della Parola eterna nelle parole umane. Questo ingresso è anch'esso kenotico: il Logos non conquista il linguaggio umano dall'esterno; lo abita dall'interno, lo assume, lo trasforma. Ma questa trasformazione non annulla il linguaggio umano; piuttosto, lo rende capace di portare un significato che lo eccede.

La struttura ontologica della kenosi incarnazionale — infinito nel finito, senza confusione e senza separazione — diviene così il modello che governa la struttura semantica e pragmatica della predicazione teologica. Se il Logos può essere pienamente presente nel finito senza confondersi con esso e senza separarsi da esso, allora il predicato creaturale può entrare nel dominio divino, essere trasformato, ed emergere come vettore di significato teologico, tutto senza che la sua natura creaturale sia annullata, e tutto mantenendo una connessione reale con il divino che rappresenta.

### 2.2 Kenosi Semantica: l'operazione sul significato predicativo

Mentre la kenosi ontologica fonda la possibilità strutturale della predicazione teologica, è la kenosi semantica che descrive *come* il significato si trasforma quando un predicato creaturale viene applicato al divino. Questa trasformazione non è casuale; è regolata da una logica interna sofisticata che gli autori medievali hanno elaborato su materiali neoplatonici, ma con una modificazione decisiva introdotta dalla considerazione cristologica.

#### La negazione trascendente in Dionigi il Mistico

Pseudo-Dionigi introduce una distinzione cruciale nel capitolo V della *Mistica Teologia*, tra negazione semplice (ἀπόφασις in senso ordinario) e negazione *trascendente* (ὑπέρ). Una negazione ordinaria è privativa (στέρησις): dire "la parete non è bianca" significa che la parete manca della qualità della bianchezza, che potrebbe avere ma non ha. Una tale negazione ordinaria, se applicata a Dio, sarebbe assolutamente inadeguata. Dire "Dio non è buono" come una semplice privazione sarebbe eretico.

Ma la negazione dionigiana non è una negazione privativa. È una negazione che designa il *trascendimento* di ogni ordine predicativo. Quando Dionigi nega dei nomi divini, non sta dicendo che Dio manca di quelle perfezioni; sta dicendo che Dio le possiede in una modalità che trascende completamente il nostro modo di intendere. Ogni "non è" significa "è al di là di" (ἐστὶν ἐπέκεινα). Il nome divino "theotès" (divinità) è al contempo eminentissimamente affermato e radicalmente negato: affermato come ciò che causa tutte le cose, negato perché la sua causalità trascende ogni causalità creaturale.³

Questa strategia dionigiana non mira al silenzio totale. Piuttosto, essa compie un'operazione sofisticata: svuota i nomi divini del loro contenuto categoriale mentre preserva la loro funzione di orientamento verso il divino. Il nome "buono" applicato a Dio è simultaneamente affermato e negato — affermato nella sua funzione di causa universale, negato in quanto modo di significare creaturale.

#### L'analogia anselimiana: significatio e usus loquendi

Anselmo di Aosta introduce una distinzione formale che avrà una lunga storia nella tradizione medievale: quella tra significatio per se e usus loquendi (o usus loquendae). Nel *Monologion* e nel *Proslogion*, Anselmo riconosce che le parole ordinarie hanno un "significato in sé," un contenuto semantico che rimanda al modo ordinario in cui le cose create possiedono le qualità. Ma quando queste parole sono applicate a Dio, il loro significato per se rimane presente (sono ancora parole che significano bontà, potenza, eternità), mentre il loro usus loquendi — il modo in cui sono usate, il contesto pragmatico della loro applicazione — si trasforma radicalmente.

Una affermazione come "Dio è più potente di qualsiasi altra cosa" non cambia il significato della parola "potenza" in sé (rimane sempre "capacità di agire"), ma il suo usus è trasformato: non significa che Dio possiede la potenza tra altre qualità, ma che Dio è la potenza — la potenza che causa tutte le altre potenze.⁴ È una doppia registrazione: il termine mantiene una continuità semantica con il suo uso creaturale, ma subisce una trasformazione nel modo in cui è impiegato.

#### La translatio in Alano di Lilla: il meccanismo formale

Alano di Lilla fornisce un nome al meccanismo formale di questa operazione: *translatio* (trasferimento). Nel suo *De arte praedicatoria* e nelle *Regulae theologicae*, Alano descrive come i predicati vengono "trasferiti" dal dominio creaturale al dominio divino. La translatio non è una semplice estensione metaforica; è un'operazione epistemicamente seria. I termini predicativi ordinari contengono, per così dire, una direzione semantica (verso il finito, il temporale, il composito) che deve essere invertita quando entrano nel dominio divino.

Un predicato, secondo Alano, ha tre dimensioni: la sua forma (forma), il suo significato (significatio), e il suo uso (usus). Nella translatio, le ultime due dimensioni subiscono una trasformazione mentre la prima rimane (pur trasformata) riconoscibile. La "bontà" quando riferita alle creature ha la forma di una qualità posseduta; il suo significato rimanda alla perfezione morale; il suo uso descrive uno stato di cose. Quando viene trasferita al divino, la forma si eleva (non è una qualità tra le altre, ma l'essenza stessa), il significato si amplia (non è più soltanto perfezione morale, ma causalità universale), e l'uso si trasforma (non descrive uno stato, ma invita il riconoscimento).

La translatio è regolata da princìpi. Alano li enumera: per ogni trasferimento, deve mantenersi l'ἀσυγχύτως (il predicato creaturale mantiene una certa autonomia semantica), l'ἀτρέπτως (il divino non è mutato dalla predicazione), e l'ἀδιαιρέτως (il significato rimane uno nonostante la trasformazione). Ancora una volta, ritroviamo la grammatica calcedonese che governa l'operazione.

#### L'analogia tommasa: res significata e modus significandi

Tommaso d'Aquino codifica queste operazioni in una formula che diviene la più influente nella tradizione scolastica. Nel *Summa Theologiae* I, questione 13, Tommaso distingue tra *res significata* (la cosa significata) e *modus significandi* (il modo di significare). Quando predicammo "Dio è buono," la res significata — la perfezione della bontà in sé — è veramente presente in Dio, anzi, è identica all'essenza divina. Il modus significandi — il modo finito, composito, limitato in cui il termine ordinariamente significa — non è presente in Dio, perché Dio è infinito, semplice, illimitato.

La kenosi semantica tommasa funziona dunque così: il modus significandi è sottratto (è una sottrazione, una kenosi), mentre la res significata è preservata ed elevata (analogia). Un predicato ordinario è una sintesi di significato composito (modus) e contenuto reale (res); nella predicazione divina, il primo elemento è negato, il secondo preservato e infinitizzato.

Ma Tommaso aggiunge un elemento cruciale: la *clausola anti-nihilista*. Non tutto questo significa che la predicazione sia vuota di valore cognitivo. Nel articolo 12 della medesima questione, Tommaso afferma che le proposizioni affermative su Dio *possono essere vere* (possunt esse verae).⁵ La kenosi semantica non è scetticismo; è una modalità sofisticata di preservare la verità della predicazione teologica pur riconoscendone l'inadeguatezza categoriale. Quando diciamo "Dio è buono," affermiamo veramente qualcosa di Dio — non affermiamo nulla di falso — sebbene il nostro modo di dire rimane infinitamente inadeguato al divino di cui parliamo.

#### La formalizzazione della kenosi semantica

La kenosi semantica può essere formalizzata come segue. Sia P un predicato creaturale (ad es., ἀγαθότης, bontà). Sia m il suo modus significandi ordinario (finito, composito, temporale) e r la sua res significata (la perfezione che esso esprime). Quando P è applicato al divino nel contesto della predicazione teologica medievale, esso subisce la seguente trasformazione:

P(creatura) = m + r
P(Deus) = ¬m + r' (dove r' è r elevato all'infinito e integrato nella semplicità divina)

La kenosi consiste precisamente in ¬m, la negazione del modus. Ma il significato non viene annullato; viene piuttosto trasfigurato in r', la res infinitizzata. La struttura parallela con Calcedonia è evidente: così come il Logos rimane divino mentre si incarna (la natura divina non è mutata, ἀτρέπτως), così il significato creaturale rimane (non è cancellato) mentre è assunto nel dominio divino (non è separato, ἀχωρίστως).

### 2.3 Kenosi Pragmatica: la trasformazione dell'atto predicativo

Se la kenosi semantica descrive ciò che accade al significato quando un predicato entra nel discorso teologico, la kenosi pragmatica descrive ciò che accade all'atto linguistico stesso — quello che i filosofi del linguaggio chiamano la "forza illocutiva."

#### Il mutamento della forza illocutiva in Dionigi

Nel prologo della *Mistica Teologia*, Dionigi offre una descrizione drammatica di questa trasformazione. Il testo inizia come un'analisi filosofica, sviluppa ragionamenti sulla natura del divino, cita le Scritture. Ma via via che il discorso procede, la modalità dell'enunciazione cambia. Non si tratta più semplice di fare affermazioni su Dio; il discorso si trasforma in invocazione, in preghiera, in lode. L'atto linguistico cambia da DESCRITTIVO (io descrivo il divino) a DOXOLOGICO (io lodo il divino che mi eccede).

Dionigi descrive questo mutamento come un'ascensione attraverso i doni dello Spirito (la fede, la speranza, la carità) verso l'unione mistica con Dio. Ma l'elemento linguistico cruciale è questo: il nome divino, una volta "ascoltato" attraverso l'elevazione dossologica, non è più compreso nel modo ordinario. Non è più semplicemente un'informazione che il divino è buono, potente, eternale; è piuttosto un'invocazione che orienta l'intera persona verso il mistero trascendente.

#### Le metafore auto-destabilizzanti del Liber XXIV Philosophorum

Un documento medievale di straordinaria importanza è il *Liber XXIV Philosophorum*, una raccolta di 24 definizioni del divino, molte delle quali sono volutamente paradossali. Eccone una celebre: "Dio è una sfera intellegibile il cui centro è ovunque e la cui circonferenza è in nessun luogo."⁶

Questa metafora è costruita in modo che *non possa essere presa letteralmente*. Se il centro è ovunque e la circonferenza in nessun luogo, non si tratta di una sfera nel senso ordinario. Eppure, la metafora non è priva di senso. Il lettore/ascoltatore che la confronta è posto di fronte a un'impossibilità logica, una contraddizione geometrica evidente. Ma proprio attraverso il confronto con questa impossibilità, la mente è sollevata oltre il pensiero ordinario verso una modalità nuova di comprensione.

L'atto pragmatico non è qui "capire una proposizione vera su Dio"; è piuttosto "essere trasformato dall'incomprensibilità stessa della proposizione." La metafora non descrive Dio; costruisce sé stessa per dissolversi, e in questa auto-dissoluzione orienta il parlante-ascoltatore verso l'intelligibilità divina che eccede ogni intelligibilità ordinaria.

#### La negatio negationis di Eckhart: il limite della kenosi pragmatica

Meister Eckhart radicalizza la kenosi pragmatica fino ai suoi confini estremi. Nel commento ai Nomi Divini, Eckhart sostiene che la negazione vera e propria non riguarda soltanto i predicati applicati a Dio, ma l'atto stesso della predicazione. Una negazione di un predicato è ancora una proposizione affermata (affermo che Dio non è buono nel modo finito). Ma Eckhart introduce la formula della negatio negationis — la negazione della negazione — che produce, paradossalmente, non un'affermazione ordinaria, ma una "superlativa affermazione" (purissima affirmatio).⁷

Eckhart scrive: "Quando dico che Dio non è né bontà né potenza, affermo di Dio più di quando dico che lo è. Infatti, mediante tale negazione, niego che egli sia questi limitatamente, e affermo che egli è infinitamente al di là."⁸

L'atto pragmatico si trasforma qui fino al punto di rivolta. Non è più un'asserzione (affermativa o negativa) nel senso ordinario. Non è nemmeno un gesto indicativo ordinario. L'enunciazione stessa è negata, "svuotata," eppure in questa negazione dell'enunciazione si produce un'affermazione della massima pienezza. È come se l'atto di parola si invertisse su sé stesso, sfociando non nel silenzio, ma in una modalità discorsiva del tutto inedita.

Gli articoli 23 e 26 del processo inquisitoriale contro Eckhart mostrano però i pericoli di questa radicalizzazione: se la negatio negationis assorbe completamente la semantica (se il "non-dire" diviene l'unico modo autentico di dire), il sistema collassa nell'irrazionalismo. La condanna della Chiesa nei confronti di Eckhart rivela che il dispositivo ha un limite: la kenosi pragmatica non può eliminare completamente la kenosi semantica senza trasformarsi in eresia. Esiste una proporzione che deve mantenersi tra i tre livelli di kenosi.

#### La formalizzazione della kenosi pragmatica

La kenosi pragmatica può essere formalizzata in termini di trasformazione della forza illocutiva. Sia F l'operatore di forza illocutiva, P il predicato, e G il referente divino. Un enunciato ordinario ha la forma:

F_ASSERTIVA (P, creatura) — io asserisco che la creatura è P

Un enunciato teologico ordinario mantiene nominalmente questa forma:

F_ASSERTIVA (P, Deus) — io asserisco che Dio è P

Ma la forza illocutiva è trasformata. Non è più una semplice asserzione descrittiva, ma una comunicazione che contiene elementi di:

1. Orientamento (F_DIRETTIVO): io dirigo il mio e l'altrui intelletto verso il divino che eccede P
2. Invocazione (F_ESPRESSIVO): io esprimo il riconoscimento della mia e dell'altrui insufficienza nel dire il divino
3. Trasformazione (F_PERFORMATIVO): io opero una trasformazione nello stato cognitivo-spirituale di colui che ascolta

Così la kenosi pragmatica non consiste nell'eliminazione della forza illocutiva, bensì nella sua *moltiplicazione*: l'enunciato teologico contiene simultaneamente molteplici forze illocutive. Non è semplicemente una proposizione vera; è un'orientamento, un'invocazione, una trasformazione spirituale.

In Eckhart, quando la negatio negationis viene spinta al massimo, la forza illocutiva stessa subisce la kenosi. Non è più semplicemente "io asserisco, dirigo, esprimo, trasformo"; diviene "io nego l'asserto, subverto la direzionalità ordinaria, esprimo l'inesprimibile, trasformo tramite la disintegrazione dell'atto stesso." È il punto di rotazione estremo della kenosi pragmatica.

### 2.4 L'omologia strutturale: come le tre kenosi si relazionano

Le tre kenosi — ontologica, semantica, pragmatica — non sono tre operazioni indipendenti che casualmente coesistono. Sussiste tra loro una *omologia strutturale*: la medesima logica profonda governa tutte e tre.

La kenosi ontologica è il fondamento. Essa descrive come l'infinito entra nel finito nel modo specifico dell'Incarnazione. Il Logos assume la carne umana, entra nell'ordine creaturale, non come un'esteriore invasione, ma come assunzione dall'interno. L'unità-nella-distinzione tra divino e umano nella persona del Logos è il modello di tutte le ulteriori operazioni.

La kenosi semantica applica questa medesima struttura al livello della significazione. Come il Logos rimane pienamente divino pur assumendo pienamente l'umanità (senza confusione, senza separazione), così il significato creaturale rimane significato (ἀχωρίστως) mentre è trasformato dalla sua applicazione al divino (ἀσυγχύτως). Il predicato creaturale non è annullato; è assunto, trasfigurato, elevato.

La kenosi pragmatica applica la medesima struttura al livello dell'atto linguistico. L'atto ordinario di predicazione — l'asserzione descrittiva — rimane riconoscibile (ἀχωρίστως, non è separato completamente dalla sua forma ordinaria) mentre è radicalmente trasformato nella sua forza (ἀσυγχύτως, non è confuso con una semplice asserzione). L'enunciato teologico rimane linguaggio (non è il silenzio), ma il linguaggio in una forma novella.

Questa omologia è ciò che rende il dispositivo *coerente*. Non è una raccolta di strategie disparate; è un sistema unificato da una medesima logica profonda che opera su tre livelli diversi. E questa logica profonda — la struttura dell'unità-nella-distinzione, dell'infinito nel finito, del divino nell'umano senza confusione e senza separazione — è la logica calcedonese.

---

## 3. LA GRAMMATICA CALCEDONESE COME STRUTTURA PROFONDA

### 3.1 Tesi: i quattro avverbi come regole di trasformazione universali

La formula di Calcedonia — con i suoi quattro avverbi ἀσυγχύτως (ἀσυγχύτως), ἀτρέπτως (ἀτρέπτως), ἀδιαιρέτως (ἀδιαιρέτως), ἀχωρίστως (ἀχωρίστως) — è stata da sempre compresa come la definizione dell'unione ipostatica di Cristo. Ma sostengo che essa funziona, nella mentalità medievale, come qualcosa di più profondo: come la *grammatica di trasformazione* che governa il modo in cui il linguaggio ordinario è convertito in linguaggio teologico. Questi quattro avverbi non sono semplicemente caratterizzazioni del mistero cristologico; sono *regole* che dettano come un predicato ordinario entra nel dominio del divino, come si trasforma, e come mantiene al contempo l'intelligibilità.

Non è che gli autori medievali coscientemente applicassero la formula calcedonese come un manuale esplicito (sebbene talora lo facciano, specialmente negli scolastici). Piuttosto, la formula calcedonese fornisce la *struttura logica profonda* che governa il loro discorso, spesso inconsapevolmente. È un po' come la grammatica generativa che governa il nostro parlare ordinario: non dobbiamo conoscere le regole sintattiche per parlarle correttamente; ma le regole sono lì, che governano il nostro discorso.

### 3.2 L'applicazione della grammatica calcedonese a ciascun autore

Prendiamo in esame come la grammatica calcedonese governa l'operazione in ciascuno dei grandi autori medievali che abbiamo considerato nei file precedenti.

#### Dionigi il Mistico: ἀσυγχύτως e ἀχωρίστως

La strategia dionigiana dei *theonyms* (i nomi divini) come "agathè" (bonità), "sophia" (sapienza), "dynamis" (potenza) si conforma precisamente ai dettami del ἀσυγχύτως e dell'ἀχωρίστως.

ἀσυγχύτως (senza confusione): ogni nome divino rimane distinguibile dagli altri. Non si confondono insieme; "bonità" rimane un concetto distinto da "sapienza." Ma non si tratta di una confusione nel nome, bensì di una confusione nel nostro modo di comprenderlo. Il nome "bonità" mantiene una forma ordinaria riconoscibile (rimane la parola "bonità"), anche se la sua applicazione al divino lo trasforma radicalmente.

ἀχωρίστως (senza separazione): sebbene i nomi rimangono distinguibili, non sono separati dal divino. Essi "raggiungono" Dio come cause di Dio. "La bonità non è semplicemente una denominazione estrinseca; essa esprime veramente una modalità divina della causalità universale. Non possiamo dire che Dio sia "solo" "bonità" o "solo" "sapienza," ma neppure possiamo dire che i nomi siano arbitrari.

#### Anselmo di Aosta: secondum nos / secundum te come istanziazione calcedonese

La distinzione anselimiana tra ciò che è vero secondum nos (dal nostro lato) e secondum te (dal lato divino) è una perfetta istanziazione della grammatica calcedonese.

Secondum nos, il significato del termine rimane quello ordinario — la "potenza" significa ordinariamente "capacità di agire": ἀσυγχύτως, non è confuso con il significato divino. Ma secondum te, il medesimo termine raggiunge il divino senza separazione: il termine non è abbandonato come arbitrario; porta con sé l'orientamento verso la perfezione che rappresenta, solo infinitizzato: ἀχωρίστως, non è separato.

L'ἀτρέπτως è implicitamente garantito dall'affermazione anselimiana che Dio non è mutato dal fatto che noi lo denominiamo diversamente. L'ἀδιαιρέτως è garantito dall'unità di Dio stesso: sebbene noi usiamo molti termini, essi tutti significano l'unica essenza divina.

#### Alano di Lilla: la translatio come operazione tetracordale

La translatio di Alano è, come abbiamo visto, governata da principi: ogni trasferimento di un termine dal creaturale al divino deve preservare il vincolo della "non-confusione" (ἀσυγχύτως, il termine creaturale rimane riconoscibile come termine) e della "non-separazione" (ἀχωρίστως, il significato divino è veramente raggiunto). Inoltre, deve garantire la "non-mutabilità" divina (ἀτρέπτως, Dio non è alterato) e la "non-divisione" del significato (ἀδιαιρέτως, la translatio non scinde il termine in due significati incomunicanti).

Alano esplicita questa conformità alla grammatica calcedonese. Nel suo commento all'ἀσυγχύτως, ad esempio, insiste che la natura creaturale di un concetto non deve essere assorbita quando entra nel discorso su Dio; rimane intelligibile come concetto creaturale, ma trasformato nel suo significato divino.⁹

#### Tommaso d'Aquino: la res / modus come istanziazione della non-confusione-non-separazione

La formula tommasa della res significata e modus significandi è una delle istanziazioni più perfette della grammatica calcedonese applicata al linguaggio teologico.

Il modus significandi è creaturale per sua natura; esso rimane finito, composito, ordinato. In questa sua natura creaturale, non è confuso con il divino: ἀσυγχύτως. Tuttavia, la res significata — il contenuto di perfezione che il modus ordinariamente veicola — è veramente presente in Dio, e non è separato dal divino: ἀχωρίστως.

Inoltre, Tommaso garantisce l'ἀτρέπτως affermando che la predicazione non altera Dio in alcun modo; Dio rimane assolutamente immutato nel suo essere. E garantisce l'ἀδιαιρέτως attraverso la tesi dell'analogia: sebbene il nostro modo di significare rimane creaturale, ciò che è significato è uno — la medesima perfezione divina in tutte le predicazioni.

Tommaso non cita esplicitamente la formula calcedonese a ogni passo del suo ragionamento sulla predicazione analogica, ma la sua struttura logica è precisamente quella della grammatica calcedonese: una preservazione della distinzione (non-confusione) combinata con una preservazione della riunione (non-separazione).

#### Eckhart: il collasso come diagnosi

Meister Eckhart è particolarmente illuminante perché mostra ciò che accade quando la grammatica calcedonese non è rigorosamente mantenuta.

Negli articoli 23 e 26 della sua condanna inquisitoriale, Eckhart afferma proposizioni come: "Ho dimandato a Dio di svuotarmi di Dio" ("Oravi Deum ut me evacuaret a Deo") e "Tutti i giusti operano senza 'perché'" ("Omnes iusti sine omni 'cur' operantur").¹⁰ Questi enunciati sembrano violare il principio dell'ἀσυγχύτως: il divino e l'umano non sembrano più distinguibili; l'esperienza dell'unione mistica viene descritta come un'indifferenziazione totale.

La condanna della Chiesa identifica precisamente il punto di rottura: quando l'ἀσυγχύτως viene violato, quando la distinzione tra divino e umano si dissolve completamente, il sistema diviene eretico. Il "no-self" mistico non può essere articolato come un'asserzione ordinaria della ragione; se viene articolato in tal modo, si trasforma in una negazione della distinzione creaturale — il che è eretico.

Eckhart rimane tuttavia un'importante figura diagnistica: mostra che il limite della kenosi pragmatica, se non rigorosamente controllato dalla grammatica calcedonese, non è il silenzio, ma l'eresia. La kenosi pragmatica non può divorare la semantica e l'ontologia; deve mantenersi in proporzione con esse.

### 3.3 L'importanza della scoperta: unificazione della struttura medievale

Ciò che emerge da questa applicazione sistematica della grammatica calcedonese a tutti i grandi autori medievali è una scoperta decisiva per gli studi medievali: **l'apparato apofatico medievale non è una raccolta disordinata di "strategie" disparate, bensì un sistema strutturato in base a una medesima grammatica profonda**.

La letteratura critica ha tendenzialmente trattato questi autori come se sviluppassero approcci separati: Dionigi ha la sua apofasi dei nomi divini; Anselmo ha il suo doppio registro; Alano ha la sua translatio; Tommaso ha la sua analogia; Eckhart ha la sua negatio negationis. È come se ciascuno avesse inventato una propria soluzione al problema dell'ineffabilità divina.

Ma questa lettura è superficiale. Sottesa a tutti questi approcci è una medesima logica, quella della grammatica calcedonese: come il Logos rimane divino mentre si incarna umano, così il significato creaturale rimane significato mentre si trasforma nel dominio divino. Come Cristo rimane senza confusione e senza separazione, così il discorso teologico rimane senza confusione (il creaturale non è assorbito, rimane riconoscibile) e senza separazione (il divino è veramente raggiunto, non è un mero equivoco nominale).

Questa unificazione è il contributo più importante della presente ricerca al campo degli studi medievali. Essa non solo spiega il rapporto interno tra i vari autori, ma fornisce un criterio diagnostico per valutare la coerenza e la stabilità della loro dottrina. Quando un autore rimane fedele alla grammatica calcedonese (come Dionigi, Anselmo, Alano, e Tommaso), il suo sistema rimane stabile e fecondo. Quando la grammatica è violata (come in alcuni passaggi di Eckhart), il sistema collassa verso l'eresia o verso il silenzio totale.
